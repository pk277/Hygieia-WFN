...
then
	...
	PROP_FILE=hygieia-rally-feature-collector.properties
fi
  
if [ "$MONGO_PORT" != "" ]; then
	# Sample: MONGO_PORT=tcp://172.17.0.20:27017
	MONGODB_HOST=11.16.42.153
#`echo $MONGO_HOST|sed 's;.*://\([^:]*\):\(.*\);\1;'`
...
feature.rallyBaseUri=${VERSIONONE_URL:-http://rally1.rallydev.com}
#Access token provided by VersionOne
feature.rallyApiKey=${VERSIONONE_ACCESS_TOKEN:-_kB9hwWTSd5tVvzHKeoY1SvTINUPYsZ7s7DGw2V0}
feature.projectObjectId=${VERSIONONE_PROJECT_ID:-9105435711}
feature.applicationName=${VERSIONONE_APP_NAME:-WFN}
